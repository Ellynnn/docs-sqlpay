...
- **Session Card:** User's work session shift time
    - Icon(s) on top right (green box) indicate the clock method (by GPS, QR or both) of the day. If there is no icon displayed, it means that user is not required to clock for that day

...
1. Draft the claim:
   ...
   | **Mileage**         | Select expense type, claim date, distance and description     |
   ...
   - For Mileage Claim,
      ...
      - **_'Calculate from Address' switch_**: User can input origin and destination of Mileage Claim and system will calculate the approximate distance between the 2 address (Caluclated distance are not allowed to edit)
...
:::info
User can choose to change the claim details by submitting a new claim (**_'Reapply' button_**) or proceed with the current claim submission (**_'Proceed' button_**) if exceed MTD/YTD limit
:::
...
1. **MTD Claim Over Limit:**
   ...
   - Manager can choose to cancel the claim approval (**_'Back' button_**) or proceed with the current claim approval (**_'Proceed' button_**)
...
User can view his and his team’s (manager only) claim transaction updates from the Activity Center (Go to Dashboard > Activity Center (Bell icon on top left))

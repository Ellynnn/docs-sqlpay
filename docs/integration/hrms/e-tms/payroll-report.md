...
1. Mavogate tp Time Attendance > Print Time Attendance Summary…
...
1. Click on Attendance Reward (Make sure all Clock Status are checked)
...
1. Navigate to Time Attendance > Print Time Attendance Unassigned Listing…
